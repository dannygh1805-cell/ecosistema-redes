...
for f in files:
    ...
    content = content.replace(
        '<a href="index.html" class="text-2xl font-black text-white hover:text-rt-cyan tracking-widest uppercase transition-colors" onclick="goToPage(event, this.getAttribute(\'href\'))">Ecosistema</a>',
    ...
    # Malla Curricular
    content = content.replace(
        '<a href="malla.html" class="text-2xl font-black text-white hover:text-rt-cyan tracking-widest uppercase transition-colors" onclick="goToPage(event, this.getAttribute(\'href\'))">Malla Curricular</a>',
    ...
    # Infraestructura
    content = content.replace(
        '<a href="laboratorio.html" class="text-2xl font-black text-white hover:text-rt-cyan tracking-widest uppercase transition-colors" onclick="goToPage(event, this.getAttribute(\'href\'))">Infraestructura</a>',
    ...
    # Recursos
    content = content.replace(
        '<a href="recursos.html" class="text-2xl font-black text-white hover:text-rt-cyan tracking-widest uppercase transition-colors" onclick="goToPage(event, this.getAttribute(\'href\'))">Recursos</a>',
    ...
    # Inscripciones
    content = content.replace(
        '<a href="recursos.html#contacto" class="mt-4 bg-rt-cyan text-rt-navy px-8 py-3 rounded-full font-black text-sm uppercase transition-transform hover:scale-105" onclick="goToPage(event, this.getAttribute(\'href\'))">Inscripciones 2026</a>',
    ...
    content = content.replace(
        '<a href="#contacto" class="mt-4 bg-rt-cyan text-rt-navy px-8 py-3 rounded-full font-black text-sm uppercase transition-transform hover:scale-105" onclick="goToPage(event, this.getAttribute(\'href\'))">Inscripciones 2026</a>',
